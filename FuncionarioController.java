...
public class FuncionarioController {
    ...
    private void escreverCabecalho() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(ARQUIVO_FUNCIONARIOS, true))) {
            ...
            writer.write("IdFuncionario,Cargo,NameFuncionario,CPFFuncionario,dataNascFuncionario,TelefoneFuncionario,enderecoFuncionario,local,numeroCasa,bairro,cidade,estado,passwordFuncionario");
    ...
    public static void main(String[] args) {
        ...
        FuncionarioModel funcionario = new FuncionarioModel(
                ...
                "21 98911-1898",   // Telefone de Contato
